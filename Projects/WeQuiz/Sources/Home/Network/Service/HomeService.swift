...
extension HomeService: HomeServiceLogic {
    public func getMyInfo<T>(_ model: T.Type, _ requestable: NetworkRequestable) -> AnyPublisher<MyInfoResponseModel?, Error> where T : Decodable {
    ...
    public func getFriendRank<T>(_ model: T.Type, _ requestable: NetworkRequestable) -> AnyPublisher<FriendRankResponseModel?, Error> where T : Decodable {
        return Future { [weak self] promise in
    ...
    public func getQuizGroup<T>(_ model: T.Type, _ requestable: NetworkRequestable) -> AnyPublisher<QuizGroupResponseModel?, Error> where T : Decodable {
        return Future { [weak self] promise in
    ...
    public func getQuizDetail<T>(_ model: T.Type, _ requestable: NetworkRequestable) -> AnyPublisher<QuizDetailResponseModel?, Error> where T : Decodable {
        return Future { [weak self] promise in
    ...
    public func deleteQuiz<T>(_ model: T.Type, _ requestable: NetworkRequestable) -> AnyPublisher<QuizDeleteResponseModel?, Error> where T : Decodable {
        return Future { [weak self] promise in
